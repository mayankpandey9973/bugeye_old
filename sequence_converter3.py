    ...
    for i in range(0,103):#    for i in range(0,103):
        ...
        if(i < 100):
            ...
            if single_pixel_sample:
                ...
                rsum = gsum = bsum = int(0)
                for px in range(ex-2,ex+3):
                    for py in range(ey-2,ey+3):
                        rsum += int(read_img[px,py][0])
                        gsum += int(read_img[px,py][1])
                        bsum += int(read_img[px,py][2])
                red = rsum/25
                green = gsum/25
                blue = bsum/25
                #red = (red/20)*20
            ...
            red = (int(read_img[Eyepos[29][1], Eyepos[29][0]][0])
                   + int(read_img[Eyepos[28][1], Eyepos[28][0]][0])
                   + int(read_img[Eyepos[48][1], Eyepos[48][0]][0])
                   + int(read_img[Eyepos[70][1], Eyepos[70][0]][0])
                   + int(read_img[Eyepos[71][1], Eyepos[71][0]][0])
                   + int(read_img[Eyepos[49][1], Eyepos[49][0]][0]))/6
            green = (int(read_img[Eyepos[29][1], Eyepos[29][0]][1])
                   + int(read_img[Eyepos[28][1], Eyepos[28][0]][1])
                   + int(read_img[Eyepos[48][1], Eyepos[48][0]][1])
                   + int(read_img[Eyepos[70][1], Eyepos[70][0]][1])
                   + int(read_img[Eyepos[71][1], Eyepos[71][0]][1])
                   + int(read_img[Eyepos[49][1], Eyepos[49][0]][1]))/6
            blue = (int(read_img[Eyepos[29][1], Eyepos[29][0]][2])
                   + int(read_img[Eyepos[28][1], Eyepos[28][0]][2])
                   + int(read_img[Eyepos[48][1], Eyepos[48][0]][2])
                   + int(read_img[Eyepos[70][1], Eyepos[70][0]][2])
                   + int(read_img[Eyepos[71][1], Eyepos[71][0]][2])
                   + int(read_img[Eyepos[49][1], Eyepos[49][0]][2]))/6
            
        elif (i==101):
            #Get colors from neighbors 12, 26, 45, 46, 27, 13
            red = (int(read_img[Eyepos[12][1], Eyepos[12][0]][0])
                   + int(read_img[Eyepos[26][1], Eyepos[26][0]][0])
                   + int(read_img[Eyepos[45][1], Eyepos[45][0]][0])
                   + int(read_img[Eyepos[46][1], Eyepos[46][0]][0])
                   + int(read_img[Eyepos[27][1], Eyepos[27][0]][0])
                   + int(read_img[Eyepos[13][1], Eyepos[13][0]][0]))/6
            green = (int(read_img[Eyepos[12][1], Eyepos[12][0]][1])
                   + int(read_img[Eyepos[26][1], Eyepos[26][0]][1])
                   + int(read_img[Eyepos[45][1], Eyepos[45][0]][1])
                   + int(read_img[Eyepos[46][1], Eyepos[46][0]][1])
                   + int(read_img[Eyepos[27][1], Eyepos[27][0]][1])
                   + int(read_img[Eyepos[13][1], Eyepos[13][0]][1]))/6
            blue = (int(read_img[Eyepos[12][1], Eyepos[12][0]][2])
                   + int(read_img[Eyepos[26][1], Eyepos[26][0]][2])
                   + int(read_img[Eyepos[45][1], Eyepos[45][0]][2])
                   + int(read_img[Eyepos[46][1], Eyepos[46][0]][2])
                   + int(read_img[Eyepos[27][1], Eyepos[27][0]][2])
                   + int(read_img[Eyepos[13][1], Eyepos[13][0]][2]))/6
            
        else: #i=102
            #Get colors from neighbors 41, 64, 87, 42, 24, 23
            red = (int(read_img[Eyepos[41][1], Eyepos[41][0]][0])
                   + int(read_img[Eyepos[64][1], Eyepos[64][0]][0])
                   + int(read_img[Eyepos[87][1], Eyepos[87][0]][0])
                   + int(read_img[Eyepos[42][1], Eyepos[42][0]][0])
                   + int(read_img[Eyepos[24][1], Eyepos[25][0]][0])
                   + int(read_img[Eyepos[23][1], Eyepos[23][0]][0]))/6
            green = (int(read_img[Eyepos[41][1], Eyepos[41][0]][1])
                   + int(read_img[Eyepos[64][1], Eyepos[64][0]][1])
                   + int(read_img[Eyepos[87][1], Eyepos[87][0]][1])
                   + int(read_img[Eyepos[42][1], Eyepos[42][0]][1])
                   + int(read_img[Eyepos[24][1], Eyepos[25][0]][1])
                   + int(read_img[Eyepos[23][1], Eyepos[23][0]][1]))/6
            blue = (int(read_img[Eyepos[41][1], Eyepos[41][0]][2])
                   + int(read_img[Eyepos[64][1], Eyepos[64][0]][2])
                   + int(read_img[Eyepos[87][1], Eyepos[87][0]][2])
                   + int(read_img[Eyepos[42][1], Eyepos[42][0]][2])
                   + int(read_img[Eyepos[24][1], Eyepos[25][0]][2])
                   + int(read_img[Eyepos[23][1], Eyepos[23][0]][2]))/6
        ...
        if(writeHex):
            ...
            write_img_data[x-8:x+9,y-14:y+15] = [red, green, blue]
            t2 = timer()
